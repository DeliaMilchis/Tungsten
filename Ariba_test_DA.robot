                                                    ...
                                                    "value": {
                                                      ...
                                                      "gizmo":{
                                                        "expression": {
                                                          ...
                                                          "gizmo":{
                                                            "text": { "string": "https://service.ariba.com/Buyer.aw/124999038/aw?awh=r&amp;awssk=I6RyKcj3&amp;dard=1" },
                                                            "comment": {
                                                              "meta":{
                                                                "className":"Comment",
                                                                "version":0
                        ...
                        "finder": {
                          ...
                          "gizmo":{
                            ...
                            "componentSelector": {
                              ...
                              "gizmo":{
                                "text": { "string": "DIV[der_rendered=\"y\"][class=\"a-login-page-center a-ies-login-page-center\"]" },
                                "comment": {
                                  "meta":{
                                    "className":"Comment",
                                    "version":0
                                ...
                                "fields": [{
                                  ...
                                  "gizmo":{
                                    ...
                                    "typeDefinition": {
                                      ...
                                      "gizmo":{
                                        "defaultVariantId": { "string": "Scroll To" },
                                        "variants": [{
                                          "meta":{
                                            "className":"DasVariant",
                                            "version":1
                                          ...
                                          "gizmo":{
                                            "name": { "string": "Scroll To" },
                                            "localizationKey": { "string": "Signature.cef.kScrollTo" },
                                            "id": { "string": "Scroll To" },
                                            "typeDefinition": {
                                              "meta":{
                                                "className":"MethodDasType",
