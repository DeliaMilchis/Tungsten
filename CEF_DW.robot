...
<object class="Robot" serializationversion="2">
  <prologue>
    ...
    <triggers/>
    <sub-robots>
      <sub-robot name="CEF_Download2_withNoWait_largeFile"/>
    </sub-robots>
    <device-mappings/>
    <referenced-snippets/>
  ...
  <property name="transitionGraph" class="Body">
    ...
    <steps class="ArrayList">
      <object class="Transition" serializationversion="3" id="1">
        <property name="name" class="String">Call CEF_Download2_withNoWait_largeFile</property>
        <property name="stepAction" class="CallRobot2Step" serializationversion="0">
          <property name="robot2Name" class="String">CEF_Download2_withNoWait_largeFile</property>
        </property>
